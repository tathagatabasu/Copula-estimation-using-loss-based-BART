...
multichain_MCMC_copula <- function(n.iter = 6000, 
  ...
  if(n.cores == 1){
    chain.list <- lapply(1:n.chain, function(x){set.seed(seed.list[x]);MCMC_copula(n.iter = n.iter, 
                                                                                  n.burn = n.burn,
                                                                                  n.tree = n.tree,
                                                                                  X = X,
                                                                                  U1 = U1,
    ...
    chain.list <- mclapply_manual(1:n.chain,
                                  \(x) MCMC_copula(n.iter = n.iter, 
                                                   ...
                                                   prior_type = prior_type, cop_type = cop_type,
                                                   adapt = adapt),
                                  mc.cores = n.cores, seed.list = seed.list)
  }
