...
# 
# 
# copula_uu2 <- sapply(1:n, function(i)BiCopSim(N=1 , family = 1, par = est_par[i]))
# 
...
# 
# plot(copula_uu[1,], copula_uu[2,], xlab = "U1", ylab = "U2")
# plot(copula_uu2[1,], copula_uu2[2,], xlab = "Predicted U1", ylab = "Predicted U2")
