...
# concave
rho_true_4 <- 0.9 - 0.3 * sin(3*X_obs)
# non-convex
...
# Frank
for (i in 1:5) {
  assign(paste0("copula_uu_",i), sapply(1:n, function(k)BiCopSim(N=1 , family = 5, par = BiCopTau2Par(family = 5, get(paste0("rho_true_",i))[k]))))
}
