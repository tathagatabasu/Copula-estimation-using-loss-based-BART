...
\section{Justification of Adaption}

TB Note: still checking ergodicity, these are the issues I am stuck with
\begin{itemize}
    \item For containment condition: the ratio of the densities is not necessarily bounded for $u_i=0$, makes it comlicated
    \item For diminishing adaption: for within model movements, it is straightforward but for in between model movements not sure how to define as the movements can happen on different nodes.
\end{itemize}
