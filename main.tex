...
\begin{definition}[Value at observation]
    Let $(T,M)$ be the regression tree along with the vector of terminal node values. Then the value at observation, $V_i$ is the terminal node value assigned to $x_i$. 
    \begin{equation*}
        V_i = g(x_i, T,M).
    \end{equation*}
\end{definition}
